...
# Lab 1
- Decide which one is faster for ad-hoc networks (TCP Reno / TCP Vegas or TCP New Reno / TCP New Vegas)
- Simulate on virtual machine with linux, using software NS2.36 (Network Simulator 2.36) (2.35 all-in-one)
